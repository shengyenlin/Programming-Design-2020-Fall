...
int main()
{
    ...
    int ticketNum1[10] = {0}, ticketNum2[10] = {0}, ticketPrice1[10] = {0}, ticketPrice2[10] = {0}, lastPrice1 = 0, lastPrice2 = 0;
    ...
    for (int i = 0; i < intervalNum1; i++)
    {
        ...
        else
        {
            ...
            currentTic2 = ticketNum2[i] - ticketNum1[i - 1];
        }
    ...
    else
    {
        ...
        {
            //先把區段票數整理好
            //Tic1, Tic2 :每個區間的區間長度, totalPrice1, totalPrice2 : 單買tic1或tic2的總和價格
            int Tic1 = 0, Tic2 = 0, totalPrice1 = 0, totalPrice2 = 0;
            int TicWanted1[100000] = {0}, TicWanted2[100000] = {0};
            for (int i = 0; i < intervalNum1; i++)
            {
                if (i == 0)
                {
